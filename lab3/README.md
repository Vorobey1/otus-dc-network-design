...
Думаю, что для Underlay необходимо использовать ULA (Unique Local Address). Для простоты (откажемся от правильно генерации сети ULA) использeм следующую сеть в одном ЦОД - FD00::/109.  
