...
4. Конфигурация АСО
5. Вывод LSDB, Neighbors, ip route 
...
5. Установить reference-bandwidth равным максимальной пропускной способности в домене OSPF или больше (В данной работе я установил этот параметр равным 100000)
